...
class Config(object):
    ...
    # Database URI
    DB_URI = os.environ.get("DATABASE_URL", "postgresql://unverjl7agp8zwk8uxwi:5HHgyhQrZMjsIoif8vagcGIFpe0j3V@b1611fc2iiqr8f5lt4kc-postgresql.services.clever-cloud.com:5432/b1611fc2iiqr8f5lt4kc")
